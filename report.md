...
Отриовка примитивов с использованием функционала canvas занимает несколько строчек, что сильно усложняет разработку. Чтобы облегчить использование отрисовеи, был создан класс **Draw**, являющейся обёрткой над функционалам canvas, обобщающий отрисовку примитивов
