...
* **AI**. Класс, отвечающий за искуственный интеллект. Реализует инструкции: 
  ...
  * **Приследование** Направляет персонажа к точке **lastSeenPoint**, которая обновляется при срабатывании соответсвующих триггеров и показывает последнее вероятное местонахождение мимика.
